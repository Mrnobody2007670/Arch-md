...
//======= Change settings =======\\
global.owner = process.env.OWNER_NUMBER || "265981232229"
global.botname = process.env.BOT_NAME || "mr nobody"
global.ownername = process.env.OWNER_NAME || "mr nobody"; //set bot owner name here 
global.prefix = process.env.PREFIX || "."; // your desired prefix symbol only
global.timezone = process.env.TIME_ZONE || "Africa/Lagos";
global.author = process.env.AUTHOR  || "mr nobody";
